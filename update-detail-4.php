...
<img src="image/update-detail-5.png" class="img-fluid mx-auto d-block"/>
</section>

<section class="detail-content">
    <div class="container">
        <div class="clear-1-5"></div>
        <p><strong>22 / 02 / 2020</strong><span class="float-right"><a class="back" href="update.php"><i class="fas fa-caret-left"></i> Back</a></span></p>
        <hr/>
        <div class="clear-1-5"></div>
        <div class="row">
            <div class="col-md-6">
                <p class="metrio-title-1">Taman Mengkuang Ria Official Launch 22 Feb 2020 !</p>
                <p>TAMAN MENGKUANG RIA @ Bukit Mertajam <br/>Date :22nd & 23rd Feb 2020 (Sat-Sun)<br/>Time :10am to 5pm</p>

                <p>					Only 62 units!  <br/>					Call : 1700 816 898 / 04 589 9887 <br/>					Waze : <a href="https://waze.com/ul/hw0zqyd1ft" target="_blank">https://waze.com/ul/hw0zqyd1ft</a> <br/> 					Google Map : <a href="https://maps.app.goo.gl/tJPbJ6u4R5XVr8EF9" target="_blank">https://maps.app.goo.gl/tJPbJ6u4R5XVr8EF9</a> <br/>					<ul>						<li>0 Entry</li>						<li>Free Legal Fees</li>					</ul>						<b>Strategic Location</b>					<ul>						<li>1.5km to Butterworth- Kulim Expressway (2min)</li>						<li>7km to Bukit Mertajam</li>						<li>11km to Seberang Jaya</li>						<li>16km to Penang Bridge</li>						<li>13km to Kulim Town</li>					</ul>								</p>
            </div>
            <div class="col-md-6">
                <div class="row">
                    <?php for ($i=1; $i <= 1; $i++) { ?>
                        <div class="col-md-4 col-content">
                            <img src="<?php echo 'image/update-detail-4/'.$i.'.png' ?>" class="img-fluid" />
                        </div>
                    <?php } ?>
                </div>
            </div>
