...
<div class="container">
    ...
    <p class="text-right"><a href="project-2.php" class="btn btn-primary btn-metrio-2">GO TO NORTHERN PROJECTS</a></p>
</div>
</section>
    ...
    <div class="row content-row">
        <div class="col-md-6 metrio-col metrio-col-1">
            <div class="row tmj-1-col-1">
                ...
                <div class="clear--5"></div>
                <p><button type="button" class="btn btn-primary btn-metrio-1">NOW OPEN FOR SALE</button></p>
                <div class="clear-1"></div>
                <p>From:<br/>
                ...
                <div class="modal-content modal-content-2">
                    ...
                    <div class="modal-body">
                        <ul class="lightSlider">
                            <?php for ($i=1; $i <= 33; $i++) { ?>
                            <li data-thumb="image/tmj-1/<?php echo $i; ?>.jpg">
                                <img src="image/tmj-1/<?php echo $i; ?>.jpg" />
                            </li>
                            <?php } ?>
                        </ul>
                    </div>
