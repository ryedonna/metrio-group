    ...
    <div class="sidebar-content">
        <div class="row desktop-menu">
            <div class="col-md-2 menu-col-1">
                <center><img src="image/menu-logo.png" class="img-fluid menu-logo" /></center>
            </div>
        ...
        <div class="row mobile-menu">
            ...
            <div class="col-md-6 menu-col-2" style=" border-left: .1rem solid #b1b1b3;">
                <ul>
                    <li class="metrio-menu-item"><a href="#"><span>ABOUT</span></a></li>
                    <li class="sidebar-dropdown metrio-menu-item active">
                        <a href="#"><span>PROJECTS</span></a>
                        <div class="sidebar-submenu" style="display:block;">
                            <ul>
                    ...
                    <li class="metrio-menu-item"><a href="#"><span>UPDATES</span></a></li>
                    <li class="metrio-menu-item"><a href="#"><span>CAREER</span></a></li>
                    <li class="metrio-menu-item"><a href="#"><span>CONTACT</span></a></li>
                </ul>
            </div>
            <div class="col-md-2 text-right menu-col-3">
                <div id="close-sidebar" class="close-sidebar">
        ...
        <div class="row mobile-menu-2">
            <div class="col-md-12">
                <p>
                    <img src="image/menu-logo.png" class="img-fluid menu-logo" />
