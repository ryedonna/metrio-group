<section class="contact" id="contact">
	<div class="row">
		<div class="col-md-5 contact-col-1">
			<p class="title-1">Have a question? <span class="title-2">Contact Us</span></p>
			...
			<form class="contactForm">
			  	...
			  	<button type="submit" class="btn btn-primary btn-metrio-1 float-right">send a message</button>
			</form>
		</div>
		<div class="col-md-7 contact-col-2">
			...
			<div class="row">
				<div class="col-md-4">
					...
					<ul>
						...
						<li><a href="tmj.php">Taman Mengkuang Jaya</a></li>
					</ul>
					<div class="clear-2"></div>
				</div>
				<div class="col-md-4">
			...
			<div class="row">
				...
				<div class="col-md-8 contact-content">
					...
					<p><i class="fas fa-mobile-alt icon"></i><span class="title-1">012-406 1221</span></p>
...
<footer class="footer mt-auto py-3">
  	<div class="container">
    	<p><span class="facebook float-left">Find us on <a href="#"><i class="fab fa-facebook"></i></a></span>2018 © Metrio Development Sdn Bhd. All Rights Reserved. | <a href="#">Privacy Policy</a> | <a href="#">Terms</a></p>
  	</div>
</footer>