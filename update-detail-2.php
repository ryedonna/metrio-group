...
<img src="image/update-detail-4.png" class="img-fluid mx-auto d-block" />
</section>

<section class="detail-content">
    <div class="container">
        <div class="clear-1-5"></div>
        <p><strong>23 / 11 / 2019</strong><span class="float-right"><a class="back" href="update.php"><i class="fas fa-caret-left"></i> Back</a></span></p>
        <hr/>
        <div class="clear-1-5"></div>
        <div class="row">
            <div class="col-md-6">
                <p class="metrio-title-1">Taman Mengkuang Ria Soft Launched</p>
                <p>A Celebration of Joy, Prosperity & Longevity</p>

                <p>Thanks to the overwhelming response from our purchasers. 53% were pre-booked.</p>
            </div>
            <div class="col-md-6">
                <div class="row">
                    <?php for ($i=1; $i <= 4; $i++) { ?>
                        <div class="col-md-4 col-content">
                            <img src="<?php echo 'image/update-detail-2/'.$i.'.jpg' ?>" class="img-fluid" />
                        </div>
                    <?php } ?>
                </div>
            </div>
