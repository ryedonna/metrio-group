...
<img src="image/update-detail-8/r.png" class="img-fluid mx-auto d-block"/>
<img src="image/update-detail-8/s.png" class="img-fluid mx-auto d-block"/>
</section>
<section class="detail-content">
    <div class="container">
        <div class="clear-1-5"></div>
        <p><strong>28 / 12 / 2021</strong><span class="float-right"><a class="back" href="update.php"><i class="fas fa-caret-left"></i> Back</a></span></p>
        <hr/>
        <div class="clear-1-5"></div>
        <div class="row">
            <div class="col-md-6">
                <p class="metrio-title-1">Taman Mengkuang Jaya 3</p>
                ...
                <div class="row">
                    <?php for ($i=1; $i <= 8; $i++) { ?>
                        <div class="col-md-4 col-content">
                            <img src="<?php echo 'image/update-detail-8/'.$i.'.jpg' ?>" class="img-fluid" />
                        </div>
