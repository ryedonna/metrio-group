...
<img src="image/update-detail-3.png" class="img-fluid mx-auto d-block"/>
</section>

<section class="detail-content">
    <div class="container">
        <div class="clear-1-5"></div>
        <p><strong>29 / 6 / 2019</strong><span class="float-right"><a class="back" href="update.php"><i class="fas fa-caret-left"></i> Back</a></span></p>
        <hr/>
        <div class="clear-1-5"></div>
        <div class="row">
            <div class="col-md-6">
                <p class="metrio-title-1">PAM Awards 2019, Malaysia's highest recognition for architecture excellent!</p>
                <p>Metrio Group is proud to announce that MetrioPlex, our Metrio Group office @ Batu Kawan had won PAM Awards 2019 (A&A Category) Silver Award during the recent PAM Awards 2019, Malaysia's highest recognition for architecture excellence.</p>

                <p>Congratulations! to CKHO Architect for the excellent job done for making MetrioPlex an eco-friendly place and creating an excellent working environment and work space for us. Here in Metrio, we believe in creating a conducive and friendly environment for our management and staff to maximise our creativity, innovation and at the same time, increase productivity. We look forward to working with our partners, to create more masterpieces to cater to the need of the housing industry as well as the commercial sector. Congratulations again for the Excellent job done!</p>
            </div>
            <div class="col-md-6">
                <div class="row">
                    <?php for ($i=1; $i <= 4; $i++) { ?>
                        <div class="col-md-4 col-content">
                            <img src="<?php echo 'image/update-detail-3/'.$i.'.jpg' ?>" class="img-fluid" />
                        </div>
                    <?php } ?>
                </div>
            </div>
