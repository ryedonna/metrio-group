...
<body>
<div class="page-wrapper chiller-theme"><a id="show-sidebar" class="btn btn-sm btn-dark show-sidebar">    <i class="fas fa-bars metrio-menu-bar"></i></a>
...
<img src="image/update-detail-2.jpg" class="img-fluid" />
</section>

<section class="detail-content">
    <div class="container">
        <div class="clear-1-5"></div>
        <p><strong>08 / 02 / 2019</strong><span class="float-right"><a class="back" href="update.php"><i class="fas fa-caret-left"></i> Back</a></span></p>
        <hr/>
        <div class="clear-1-5"></div>
        <div class="row">
            <div class="col-md-6">
                <p class="metrio-title-1">25th Anniversary & The Official Launch of MetrioPlex</p>
                <p>A Celebration of Joy, Prosperity & Longevity</p>

                <p>During the CNY 2019, Metrio is celebrating our 25th birthday and also the official launch of MetrioPlex. We had organised lots of fun activities at this celebration. Click to view our event pictures.</p>
            </div>
            <div class="col-md-6">
                <div class="row">
                    <?php for ($i=1; $i <= 38; $i++) { ?>
                        <div class="col-md-4 col-content">
                            <img src="<?php echo 'image/update-detail-1/'.$i.'.jpg' ?>" class="img-fluid" />
                        </div>
                    <?php } ?>
                </div>
            </div>
