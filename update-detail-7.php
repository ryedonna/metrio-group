...
<img src="image/update-detail-7/h.png" class="img-fluid mx-auto d-block"/>
</section>
<section class="detail-content">
    <div class="container">
        <div class="clear-1-5"></div>
        <p><strong>4 / 5 / 2020</strong><span class="float-right"><a class="back" href="update.php"><i class="fas fa-caret-left"></i> Back</a></span></p>
        <hr/>
        <div class="clear-1-5"></div>
        <div class="row">
            <div class="col-md-6">
                <p class="metrio-title-1">Taman Mengkuang Jaya 2</p>
            ...
            <div class="col-md-6">
              ...
              <div class="row">Sep 2023
              </div>
              <div class="row">
                  <?php for ($i=168; $i <= 172; $i++) { ?>
                      <div class="col-md-4 col-content">
                          <img src="<?php echo 'image/update-detail-7/'.$i.'.jpg' ?>" class="img-fluid" />
                      </div>
              ...
              <div class="row">Jul 2023
              </div>
              <div class="row">
                  <?php for ($i=155; $i <= 167; $i++) { ?>
                      <div class="col-md-4 col-content">
                          <img src="<?php echo 'image/update-detail-7/'.$i.'.jpg' ?>" class="img-fluid" />
                      </div>
              ...
              <div class="row">Jun 2023
              </div>
              <div class="row">
                  <?php for ($i=149; $i <= 154; $i++) { ?>
                      <div class="col-md-4 col-content">
                          <img src="<?php echo 'image/update-detail-7/'.$i.'.jfif' ?>" class="img-fluid" />
                      </div>
              ...
              <div class="row">May 2023
              </div>
              <div class="row">
                  <?php for ($i=141; $i <= 148; $i++) { ?>
                      <div class="col-md-4 col-content">
                          <img src="<?php echo 'image/update-detail-7/'.$i.'.jpg' ?>" class="img-fluid" />
                      </div>
              ...
              <div class="row">Mar 2023
              </div>
              <div class="row">
                  <?php for ($i=129; $i <= 140; $i++) { ?>
                      <div class="col-md-4 col-content">
                          <img src="<?php echo 'image/update-detail-7/'.$i.'.jpeg' ?>" class="img-fluid" />
                      </div>
              ...
              <div class="row">Feb 2023
              </div>
              <div class="row">
                  <?php for ($i=120; $i <= 128; $i++) { ?>
                      <div class="col-md-4 col-content">
                          <img src="<?php echo 'image/update-detail-7/'.$i.'.jpg' ?>" class="img-fluid" />
                      </div>
              ...
              <div class="row"> Jan 2023
                              </div>
                              <div class="row">
                                  <?php for ($i=112; $i <= 119; $i++) { ?>
                                      <div class="col-md-4 col-content">
                                          <img src="<?php echo 'image/update-detail-7/'.$i.'.jpg' ?>" class="img-fluid" />
                                      </div>
              ...
              <div class="row"> Dec 2022
                              </div>
                              <div class="row">
                                  <?php for ($i=106; $i <= 111; $i++) { ?>
                                      <div class="col-md-4 col-content">
                                          <img src="<?php echo 'image/update-detail-7/'.$i.'.jpg' ?>" class="img-fluid" />
                                      </div>
              ...
              <div class="row"> Nov 2022
                              </div>
                              <div class="row">
                                  <?php for ($i=100; $i <= 105; $i++) { ?>
                                      <div class="col-md-4 col-content">
                                          <img src="<?php echo 'image/update-detail-7/'.$i.'.jpg' ?>" class="img-fluid" />
                                      </div>
              ...
              <div class="row"> Oct 2022
                              </div>
                              <div class="row">
                                  <?php for ($i=95; $i <= 100; $i++) { ?>
                                      <div class="col-md-4 col-content">
                                          <img src="<?php echo 'image/update-detail-7/'.$i.'.jpeg' ?>" class="img-fluid" />
                                      </div>
