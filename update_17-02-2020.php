            ...
            <div class="carousel-inner w-100" role="listbox">
                ...
                <div class="carousel-item active">
                    <div class="d-block col-4">
                        <img class=" img-fluid" src="image/update-banner-4.jpg">
                        <div class="clear-1"></div>
                        <p>08 / 02 / 2019</p>
                        <hr/>
                        <p><strong>25th Anniversary & The Official Launch of MetrioPlex</strong></p>
                        <p>A Celebration of Joy, Prosperity & Longevity<br/>
						During the CNY 2019, Metrio is celebrating our 25th birthday and also the official launch of MetrioPlex. We had organised lots of fun activities at this celebration. Click to view our event pictures.</p>
                        <p><a href="update-detail-1.php" class="btn btn-primary btn-metrio-2">read more</a></p>
                    </div>
                </div>
            </div>
        </div>
